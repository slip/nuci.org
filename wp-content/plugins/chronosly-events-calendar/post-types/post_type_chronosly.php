...
//                    else $pos += 10000000;
        ...
        public static function chronosly_templates($template)
        {
            ...
            wp_register_script( 'chronosly-gmap', 'https://maps.googleapis.com/maps/api/js?key='.$settings["chronosly_gmap_api"].'&v=3.exp&sensor=false', array( 'jquery' ));
...
// otherwise all custom meta fields are cleared out
        ...
        public function inicia_scripts(){
            ...
            wp_register_script( 'chronosly-gmap', 'https://maps.googleapis.com/maps/api/js?key='.$this->settings["chronosly_gmap_api"].'&v=3.exp&sensor=false', array( 'jquery' ));
                wp_enqueue_script('chronosly-gmap');
