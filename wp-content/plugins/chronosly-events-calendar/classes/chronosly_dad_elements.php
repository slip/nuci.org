        ...
        function chronosly_create_ticket_link($value, $vars, $html = 0)
        {
            ...
            if($link){
                if(stripos($link, "wc_buy")!== FALSE &&  class_exists( 'WooCommerce' ) ) {
                    ...
                    $link .= "&eid=".$vars->pid;
                    $from = $this->create_time_format_item( "", array("value"=> "Y-m-d_H:i", "extra" => "start_datetime") , $vars);
                    $to = $this->create_time_format_item( "", array("value"=> "Y-m-d_H:i", "extra" => "end_datetime") , $vars);
